...
async function assertAssetEndpoints() {
  ...
  const schemaBackedResponses = [
    ...
    ["/api/user-services/{id}", "get", "200"],
    ["/api/user-services/{id}", "patch", "200"],
    ["/api/consultation-requests", "post", "200"],
    ["/api/payments/request-link", "post", "200"],
    ...
    ["/api/admin/requests/consultations", "get", "200"],
    ["/api/admin/requests/consultations/{id}", "patch", "200"],
    ["/api/admin/requests/payment-links", "get", "200"],
    ["/api/admin/requests/payment-links/{id}", "patch", "200"],
