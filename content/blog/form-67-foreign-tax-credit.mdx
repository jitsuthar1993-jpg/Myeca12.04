---
{
  ...
  "seoTitle": "Form 67 Foreign Tax Credit Guide for Indian ITR",
...
Form 67 supports foreign tax credit. Schedule FSI/TR details should match. DTAA review is important.
...
For this specific topic, the reviewer should document the working position for "What Is Form 67 and When Is It Needed for Foreign Tax Credit?" using the taxpayer's facts, the selected AY 2026-27 form, the records used for computation, and the reason each major number appears in the return. The note should explicitly mention whether the issue affects form selection, income classification, deduction eligibility, tax credit matching, refund timing, notice response, or disclosure schedule completion.
