---
{
  ...
  "audience": "businesses",
  "targetAudience": "Applicants preparing for funding documentation who need to A data room should connect legal, financial, tax, and business records using Funding documentation should be tailored to the investor, lender, incubator, or scheme route and Gap notes help founders resolve mismatches before review conversations.",
  "sourceLinks": [
    {
      "label": "Startup India",
