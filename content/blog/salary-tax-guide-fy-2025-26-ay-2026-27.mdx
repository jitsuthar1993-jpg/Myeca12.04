---
{
  ...
  "targetAudience": "Indian taxpayers or business owners resolving salary tax guide AY 2026-27 from current rules and source records.",
  "sourceLinks": [
    {
...
- List salary from every employer first, then separately identify interest, house property, gains, exempt income, and any other non-salary item.
...
## Salary tax: Documents to reconcile for salary tax 2026-27
...
## Final filing checks for salary tax 2026-27
...
- The final salary-return preview shows the correct employer records, PAN, refund bank account, tax regime, refund or demand, and e-verification method.
...
The most consequential mistake is often choosing the wrong correction route after filing. For salary tax, a revised return, rectification request, AIS feedback, ITR-U, demand payment, grievance, and notice reply each address different problems. Do not use a route simply because it is the first one visible on the portal.
...
## Salary tax: Related filing paths for salary tax 2026-27
...
## Salary tax: evidence and limitations

For salary tax, record the selected assessment year, taxpayer status, ITR form, income heads, tax regime, source records, and the reason each major figure appears in the return. Record the dates that affect salary tax — Form 16 issue date, AIS update, TDS return processing, e-verification, revised-return deadline, or notice response window — write the relevant date next to the decision.

For salary tax guide AY 2026-27, the minimum file should include the computation, portal downloads, source statements, challans, acknowledgement, and correspondence. This article is educational preparation, not legal advice for any specific taxpayer's facts.

## Salary tax: What to do after the salary tax check
