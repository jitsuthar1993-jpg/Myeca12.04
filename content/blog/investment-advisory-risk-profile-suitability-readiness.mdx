---
{
  ...
  "faqs": [
    ...
    {
      "question": "For investment advisory, what should be ready before an advisory session?",
  ...
  "audience": "businesses",
  "targetAudience": "Indian taxpayers or business owners resolving investment advisory from current rules and source records.",
  "sourceLinks": [
    {
...
- [Review investment advisory service scope](/services/investment-advisory)
- [Choose the filing route for investment advisory](/itr/form-selector)
