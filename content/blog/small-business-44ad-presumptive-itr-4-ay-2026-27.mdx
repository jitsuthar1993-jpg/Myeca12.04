...
Official AY 2026-27 materials describe ITR-4 for eligible taxpayers computing business or profession income on presumptive basis under specified sections.
...
A small trader has UPI receipts, cash sales, GST returns, and bank deposits. Before using ITR-4, the owner should reconcile turnover and tax-credit records.
...
- Using GST turnover without reconciliation.
- Ignoring cash deposits.
- Missing TDS credit.
- Using ITR-4 despite exclusions.
