---
{
  ...
  "audience": "businesses",
  "targetAudience": "Founders and finance teams handling PAN card assistance who need to PAN details should match bank, GST, MCA, Udyam, and tax records using Business PAN requirements differ by entity type and Correction work should preserve acknowledgement and updated proof.",
  "sourceLinks": [
    {
