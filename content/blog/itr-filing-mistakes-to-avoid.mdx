...
| --- | --- |
| Acting from memory | Approximate salary, investment, GST, or bank figures do not support a defensible filing position. |
| Using only one record | Form 16 may miss bank interest; AIS may contain duplicates; GST returns may not match books; broker reports may need classification review. |
...
| Weak documentation | Missing rent proof, investment receipts, broker statements, GST invoices, challans, or portal downloads makes later review harder and slower. |
