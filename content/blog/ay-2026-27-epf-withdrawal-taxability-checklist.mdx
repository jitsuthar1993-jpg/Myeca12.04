---
{
  ...
  "keyTopics": [
    "check TDS, service period, EPF statement, and whether withdrawal income needs reporting",
    "EPF statement",
    "Form 16A if issued",
    "bank credit proof"
  ],
...
## Rebuild service and contribution history before classifying the withdrawal
