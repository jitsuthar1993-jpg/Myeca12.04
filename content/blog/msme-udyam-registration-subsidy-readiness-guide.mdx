---
{
  ...
  "audience": "businesses",
  "targetAudience": "Applicants preparing for MSME Udyam registration who need to Udyam registration supports MSME identity but does not itself approve a subsidy using Scheme readiness depends on clean KYC, registrations, banking, invoices, and project documents and MyeCA can help organize the file before an official scheme application is submitted.",
  "sourceLinks": [
    {
