---
{
  ...
  "targetAudience": "Taxpayers using Form 26AS is important for tax credits and Download records before final return preview to AIS shows broader reported information before filing or responding for download AIS TIS Form 26AS.",
  "sourceLinks": [
    {
...
## Download AIS 26AS: Build the evidence file for download AIS 26AS
...
## Download AIS 26AS: Errors that can change download AIS 26AS
...
## Download AIS 26AS: Continue with the next download AIS 26AS step
...
## Download AIS 26AS: records to reconcile
...
## Download AIS 26AS: Move forward after reviewing download AIS 26AS
