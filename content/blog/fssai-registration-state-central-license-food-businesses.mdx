---
{
  ...
  "audience": "businesses",
  "targetAudience": "Founders and finance teams handling FSSAI registration who need to The FSSAI route depends on food activity, scale, premises, and operating model using FoSCoS is the official compliance system for food business licensing and registration work and MyeCA assists with readiness and application guidance, not government issuance.",
  "sourceLinks": [
    {
      "label": "FoSCoS Portal",
