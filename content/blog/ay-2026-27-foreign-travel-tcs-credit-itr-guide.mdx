---
{
  ...
  "targetAudience": "Taxpayers using TCS certificate, travel invoice, and Form 26AS to match TCS on foreign travel packages or remittances with Form 26AS and AIS before filing or responding for foreign travel TCS credit ITR AY 2026-27.",
...
The Income Tax Department's [AIS guidance](https://www.incometax.gov.in/iec/foportal/help/all-topics/e-filing-services/ais-annual-information-statement) and [tax-credit mismatch FAQ](https://www.incometax.gov.in/iec/foportal/node/11487) describe the portal records involved. Sources and follow-up checks include the [overseas-remittance TCS checklist](/blog/ay-2026-27-overseas-remittance-tcs-itr-checklist), [income tax calculator](/calculators/income-tax), and [document-handling policy](/trust).

## travel-TCS closing evidence

travel-TCS work begins by naming the period, taxpayer, and event before any amount is copied into a schedule. travel-TCS records should be matched to the statement, certificate, contract, ledger, portal download, or notice that actually supports the fact. travel-TCS differences need a dated explanation that distinguishes timing from ownership, classification, correction, or missing evidence. travel-TCS calculations should preserve inputs, formula, source version, and rounding rather than only the final total. travel-TCS files should end with the figure used, the next action, and the current official instruction checked for the relevant form, rate, eligibility condition, or deadline.
