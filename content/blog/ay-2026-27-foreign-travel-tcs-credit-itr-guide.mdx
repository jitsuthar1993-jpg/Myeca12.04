...
The Income Tax Department's [AIS guidance](https://www.incometax.gov.in/iec/foportal/help/all-topics/e-filing-services/ais-annual-information-statement) and [tax-credit mismatch FAQ](https://www.incometax.gov.in/iec/foportal/node/11487) describe the portal records involved. For the next step, use the [overseas-remittance TCS checklist](/blog/ay-2026-27-overseas-remittance-tcs-itr-checklist), test the final figures in the [income tax calculator](/calculators/income-tax), and follow the [document-handling policy](/trust).

<!-- ay-route-specific-depth:start -->
## Follow the TCS credit from traveller to collector
