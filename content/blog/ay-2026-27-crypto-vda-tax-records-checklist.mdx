...
Use this guide for transaction-treatment and record questions, and review the [high-value AIS checklist](/blog/ay-2026-27-high-value-transaction-ais-checklist) when reported entries do not align with the inventory. Exchange shutdowns, inaccessible wallets, missing cost history, overseas accounts, and large peer-to-peer transactions are escalation points because the ordinary exchange export may not support the filed position.

<!-- ay-route-specific-depth:start -->
## Trace ownership and taxable transfers across wallets
