---
{
  ...
  "audience": "businesses",
  "targetAudience": "Freelancers and owner-managed businesses using Business facts can move the taxpayer to ITR-3 and TDS and receipts must be reconciled to ITR-4 is optional and only for eligible presumptive cases before finalising the return.",
  "sourceLinks": [
    {
...
## The practical position on ITR-4 2026-27
...
## Official position for ITR-4 2026-27
...
## Example using ITR-4 2026-27 records
...
## ITR-4: Build the evidence file for ITR-4 2026-27
...
## Before filing ITR-4 2026-27

- For ITR-4, confirm AY 2026-27 is the correct assessment year for FY 2025-26 income.
...
## ITR-4: Errors that can change ITR-4 2026-27
...
## ITR-4: Continue with the next ITR-4 2026-27 step
...
## Resolve evidence gaps before ITR-4

Before filing ITR-4, record the selected assessment year, taxpayer residential status, ITR form chosen, the presumptive taxation section relied upon, income heads covered, tax regime, source records used, and the reason each major figure appears in the return. Where the presumptive eligibility is marginal or the taxpayer previously opted out, that position should be clearly noted.
...
## ITR-4: What to do after the ITR-4 check
