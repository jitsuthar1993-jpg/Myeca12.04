---
{
  ...
  "audience": "businesses",
  "targetAudience": "Founders and finance teams handling ISO certification who need to Certification scope should be defined before document work begins using Quality records and process ownership matter more than generic templates and MyeCA supports readiness and documentation, not certification issuance.",
  "sourceLinks": [
    {
