---
{
  ...
  "faqs": [
    ...
    {
      "question": "For trade license, what should be checked before applying?",
  ...
  "audience": "businesses",
  "targetAudience": "Founders and finance teams handling trade license registration who need to Trade license rules are local and authority-specific using Food businesses may need FSSAI along with local trade permission and Renewal and premises changes should be tracked after registration.",
  "sourceLinks": [
    {
      "label": "India Code",
...
## Get help before finalising trade license
...
### Is trade license the same in every city?
...
### For trade license, what should be checked before applying?
...
## Trade license: Continue with the nearest trade license action
...
- [Review Trade License service scope](/services/trade-license)
- [Compare business compliance services](/all-services)

<!-- route-specific-depth:start -->
## Build a premises-specific local permission file
