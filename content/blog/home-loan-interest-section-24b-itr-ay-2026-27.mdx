...
House property income and interest should be reported with supporting details and within the form and regime treatment applicable to the taxpayer.
...
A taxpayer has a self-occupied house with loan interest and salary income. They should compare old and new regime, check property schedule details, and preserve the lender certificate.
...
- Claiming interest without certificate.
- Ignoring co-owner share.
- Wrong property classification.
- Assuming new regime gives the same benefit.
...
Ownership, repayment, and certificate facts should be reviewed before claiming.
