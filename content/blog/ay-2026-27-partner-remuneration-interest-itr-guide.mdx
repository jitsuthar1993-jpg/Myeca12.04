---
{
  ...
  "audience": "businesses",
  "targetAudience": "Freelancers and owner-managed businesses using firm computation, capital account, and bank statement to match firm K-1 style records, remuneration, interest, capital account, and form selection before finalising the return.",
...
## partner-firm closing evidence

partner-firm work begins by naming the period, taxpayer, and event before any amount is copied into a schedule. partner-firm records should be matched to the statement, certificate, contract, ledger, portal download, or notice that actually supports the fact. partner-firm differences need a dated explanation that distinguishes timing from ownership, classification, correction, or missing evidence. partner-firm calculations should preserve inputs, formula, source version, and rounding rather than only the final total. partner-firm files should end with the figure used, the next action, and the current official instruction checked for the relevant form, rate, eligibility condition, or deadline.
