---
{
  ...
  "targetAudience": "Taxpayers preparing ITR form selection AY 2026-27 who need to Start with income heads, not convenience using Capital gains, business income, and foreign assets can change the form and Simpler forms are useful only when eligibility fits.",
  "sourceLinks": [
    {
