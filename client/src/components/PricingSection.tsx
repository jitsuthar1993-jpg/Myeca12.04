  ...
  return (
    <section className="bg-white border-y border-gray-100">
      ...
      <div className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-between gap-6 rounded-lg border border-slate-100 bg-slate-50 p-8 md:flex-row">
          ...
          <Link href="/expert-consultation?service=pricing-help">
            <Button variant="outline" className="rounded-lg border-slate-300 px-8 py-6 font-bold text-slate-700">
              Talk to Expert
            </Button>
          </Link>
        </div>
