...
const searchableContent = [
  // Services
  { id: 1, title: "ITR Filing", type: "service", url: "/which-itr-form-to-file?source=global_search", description: "Start income tax return filing with guided form selection", keywords: ["income tax", "return", "filing", "itr"] },
