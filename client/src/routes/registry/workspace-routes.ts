...
export const WORKSPACE_ROUTES = [
  ...
  route("/itr/filing", "workspace", "client/src/features/itr/pages/hub.page.tsx"),
  route("/itr/filing/new", "workspace", "client/src/features/itr/pages/new-filing.page.tsx"),
  route("/itr/filing/:returnId", "workspace", "client/src/features/itr/pages/filing.page.tsx"),
