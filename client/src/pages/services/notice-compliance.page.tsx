          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section>
              <div className="flex items-center gap-2 mb-6">
                ...
                <h2 className="text-xl font-bold text-slate-900">Notices We Handle</h2>
              </div>
              <div className="grid md:grid-cols-2 gap-4">
                {noticeTypes.map((notice) => (
                  <Card key={notice.id} className="hover:shadow-md transition-shadow duration-200 border-slate-200">
            ...
            <section>
              <div className="flex items-center gap-2 mb-6">
                ...
                <h2 className="text-xl font-bold text-slate-900">Resolution Process</h2>
              </div>
                  ...
                  {processSteps.map((step, index) => (
                    <div key={index} className="relative text-center">
                      {index < processSteps.length - 1 && (
                        <div className="hidden md:block absolute top-6 left-1/2 w-full h-0.5 bg-slate-100 -z-10" />
                      )}
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24">
              <Card className="shadow-lg border-red-100 overflow-hidden">
                ...
                <CardContent className="p-5 space-y-4">
                  <div className="space-y-2">
                    <Label className="text-xs uppercase text-slate-500 font-semibold">Notice Type</Label>
                  ...
                  <div className="space-y-2">
                    <Label className="text-xs uppercase text-slate-500 font-semibold">Contact Details</Label>
                    <Input placeholder="Full Name" className="h-9" />
                    <Input placeholder="Phone Number" className="h-9 mt-2" />
                  </div>

                  <div className="space-y-2">
                    <Label className="text-xs uppercase text-slate-500 font-semibold">Upload Notice (Optional)</Label>
                    <div className="border-2 border-dashed border-slate-200 rounded-lg p-4 text-center hover:bg-slate-50 transition-colors cursor-pointer">
                      ...
                      <p className="text-xs text-slate-500">Click to upload PDF/JPG</p>
                    </div>
                  </div>
                  ...
                  <p className="type-meta text-center text-slate-400">
              ...
              <div className="mt-6 p-4 bg-white rounded-xl border border-slate-200 text-center">
                ...
                <a href={CONTACT.callbackHref} className="text-lg font-bold text-slate-900 flex items-center justify-center gap-2">
             ...
             <CardContent className="p-0">
                <table className="w-full text-left border-collapse">
                   ...
                   <tbody className="text-sm font-medium text-slate-600">
                      <tr className="border-b border-slate-50 hover:bg-red-50/30 transition-colors">
