            ...
            <div className="md:hidden">
              <div className="rounded-lg border border-blue-100 bg-blue-50 p-4">
                ...
                <div className="type-meta mt-3 grid grid-cols-2 gap-2 font-semibold text-slate-600">
                  {["CA-assisted workflow", "Scope before payment", "CA review", "Secure documents"].map((item) => (
        ...
        <section className="hidden border-b border-slate-200 bg-[#F8FAFC] py-4 md:block md:py-6">
          <div className="container mx-auto px-4">
            <div className="mx-auto grid max-w-6xl gap-3 sm:grid-cols-2 lg:grid-cols-4">
              {[
                { icon: Shield, title: "CA-assisted workflow", text: "Review and filing steps are aligned to official income-tax portal requirements." },
            ...
            <div className="relative mx-auto max-w-4xl overflow-hidden rounded-lg border border-slate-200/60 bg-white p-5 text-left shadow-sm md:rounded-card md:p-12 md:text-center md:shadow-[0_15px_40px_-10px_rgba(0,0,0,0.08)] lg:p-16">
              ...
              <div className="relative z-10">
                <div className="mb-4 inline-flex items-center gap-2 rounded-lg border border-blue-100/50 bg-blue-50/50 px-3 py-2 text-xs font-semibold text-brand-600 md:mb-8 md:rounded-full md:px-5">
                  ...
                  CA-assisted workflow · CA review · Official portal guidance
                </div>
