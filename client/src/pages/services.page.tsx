    ...
    services: [
      {
        ...
        price: priceFor("itr-filing", "From Rs.999"),
        meta: "24-48 hrs",
      },
      {
        title: "Capital Gains",
      ...
      },
      {
        ...
        price: priceFor("notice-compliance", "From Rs.2,999"),
        meta: "Priority help",
      },
    ],
  },
    ...
    services: [
      {
        ...
        price: priceFor("gst-registration", "From Rs.2,999"),
        meta: "3-7 days",
      },
      {
        title: "GST Returns",
        ...
        price: priceFor("gst-returns", "Rs.999/month"),
        meta: "Monthly",
      },
      {
        ...
        price: priceFor("company-registration", "From Rs.6,999"),
        meta: "10-15 days",
      },
    ],
  },
    ...
    services: [
      {
        ...
        price: priceFor("trademark-registration", "From Rs.12,999"),
        meta: "IP support",
      },
      {
...
const proofPoints = [
  ...
  { value: "24h", label: "Fastest ITR turnaround" },
];
