      ...
      <section className="bg-white border-b soft-border py-16">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <h1 className="type-page-title mb-4 text-slate-900">Refund Policy</h1>
      ...
      <section className="py-16">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          >
            {/* Overview */}
            <div className="mb-12">
              <h2 className="text-2xl font-bold text-slate-900 mb-6">Refund Policy Overview</h2>
            ...
            <div className="mb-12">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-slate-900">Refund Eligibility by Service Type</h2>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="border border-slate-200 rounded-lg p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-slate-900">Tax Filing Services (ITR, GST, TDS)</h3>
                  </div>
                ...
                <div className="border border-slate-200 rounded-lg p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-slate-900">Business Registration & Incorporation</h3>
                  </div>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                ...
                <div className="border border-slate-200 rounded-lg p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-slate-900">Compliance & Annual Services</h3>
                  </div>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
            ...
            <div className="mb-12">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-slate-900">Refund Processing Timeline</h2>
              </div>
              ...
              <div className="bg-blue-50 p-6 rounded-lg">
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="text-center">
                    ...
                    <h3 className="font-semibold text-slate-900 mb-2">Request Submission</h3>
                    <p className="text-slate-600 text-sm">Submit refund request with details and supporting documents</p>
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="font-semibold text-slate-900 mb-2">Review & Approval</h3>
                    <p className="text-slate-600 text-sm">Our team reviews your request and determines eligibility</p>
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="font-semibold text-slate-900 mb-2">Refund Processing</h3>
                    <p className="text-slate-600 text-sm">Amount credited to your original payment method</p>
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold text-slate-900 mb-6">Special Circumstances</h2>
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold text-slate-900 mb-6">How to Request a Refund</h2>

              <div className="bg-slate-50 p-6 rounded-lg">
                <h3 className="font-semibold text-slate-900 mb-4">Required Information for Refund Request:</h3>
            ...
            {/* Refund Methods */}
            <div className="mb-12">
              <h2 className="text-2xl font-bold text-slate-900 mb-6">Refund Methods</h2>

              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center p-4 border border-slate-200 rounded-lg">
                  <Coins className="w-8 h-8 text-green-600 mx-auto mb-3" />
                  <h3 className="font-semibold text-slate-900 mb-2">Original Payment Method</h3>
                ...
                <div className="text-center p-4 border border-slate-200 rounded-lg">
                  ...
                  <h3 className="font-semibold text-slate-900 mb-2">Service Credit</h3>
                  <p className="text-slate-600 text-sm">
            ...
            {/* Contact for Refunds */}
            <div className="mb-12">
              <h2 className="text-2xl font-bold text-slate-900 mb-6">Contact for Refund Requests</h2>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">refunds@myeca.in</p>
                    <p className="text-slate-600">support@myeca.in</p>
                    <p className="text-slate-600 text-sm mt-1">Reviewed during Mon-Sat business hours</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-slate-900">Refund Support</h3>
                    <p className="text-slate-600">Request support by email</p>
                    <p className="text-slate-600 text-sm">Mon-Sat: 9 AM - 7 PM IST</p>
                    <p className="text-slate-600 text-sm">Refund Specialist Available</p>
                  </div>
                </div>
              </div>
            </div>
