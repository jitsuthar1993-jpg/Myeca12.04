      ...
      <section className="py-16">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          >
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold text-slate-900 mb-6">Service-Specific Disclaimers</h2>
              ...
              <div className="space-y-6">
                ...
                <div className="border border-slate-200 rounded-lg p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-slate-900">Tax Filing & Advisory Services</h3>
                  </div>

                  <div className="space-y-3">
                    <div>
                      <h4 className="font-medium text-slate-900 mb-2">No Guarantee of Outcomes</h4>
                    ...
                    <div>
                      <h4 className="font-medium text-slate-900 mb-2">Client Responsibility</h4>
                      <ul className="text-slate-600 text-sm space-y-1 list-disc list-inside">
                ...
                <div className="border border-slate-200 rounded-lg p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-slate-900">Business Registration & Compliance</h3>
                  </div>

                  <div className="space-y-3">
                    <div>
                      <h4 className="font-medium text-slate-900 mb-2">Regulatory Approvals</h4>
                      <ul className="text-slate-600 text-sm space-y-1 list-disc list-inside">
                    ...
                    <div>
                      <h4 className="font-medium text-slate-900 mb-2">Ongoing Compliance</h4>
                      <ul className="text-slate-600 text-sm space-y-1 list-disc list-inside">
                ...
                <div className="border border-slate-200 rounded-lg p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-slate-900">Financial Calculators & Tools</h3>
                  </div>
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold text-slate-900 mb-6">Professional Advice Limitations</h2>

              <div className="bg-slate-50 p-6 rounded-lg">
                <div className="space-y-4">
                  <div>
                    <h3 className="font-semibold text-slate-900 mb-2">Not a Substitute for Professional Consultation</h3>
                  ...
                  <div>
                    <h3 className="font-semibold text-slate-900 mb-2">Individual Circumstances</h3>
                    <p className="text-slate-600 text-sm">
                  ...
                  <div>
                    <h3 className="font-semibold text-slate-900 mb-2">Legal and Regulatory Changes</h3>
                    <p className="text-slate-600 text-sm">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold text-slate-900 mb-6">Third-Party Services & Links</h2>

              <div className="space-y-4">
                <div className="flex items-start">
                  <ExternalLink className="w-5 h-5 text-blue-600 mr-3 mt-1" />
                  <div>
                    <h3 className="font-semibold text-slate-900 mb-2">External Links</h3>
                    <p className="text-slate-600 text-sm">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-slate-900 mb-2">Payment Gateways</h3>
                    <p className="text-slate-600 text-sm">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-slate-900 mb-2">Government Portals</h3>
                    <p className="text-slate-600 text-sm">
            ...
            {/* User Acknowledgment */}
            <div className="mb-12">
              <h2 className="text-2xl font-bold text-slate-900 mb-6">User Acknowledgment</h2>
            ...
            {/* Contact Information */}
            <div className="mb-12">
              <h2 className="text-2xl font-bold text-slate-900 mb-6">Questions About This Disclaimer</h2>
              <p className="text-slate-600 mb-4">
              ...
              <div className="bg-slate-50 p-6 rounded-lg">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="text-slate-600 text-sm">legal@myeca.in</p>
                    <p className="text-slate-600 text-sm">support@myeca.in</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-slate-900 mb-2">Support</h3>
                    <p className="text-slate-600 text-sm">Request support by email</p>
            ...
            <div className="border-t border-slate-200 pt-8">
              <h2 className="text-2xl font-bold text-slate-900 mb-4">Updates to This Disclaimer</h2>
