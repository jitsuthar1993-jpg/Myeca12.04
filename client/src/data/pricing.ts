...
export const taxFilingPlans: PricingPlan[] = [
  {
    ...
    description: "For simple ITR-1 cases with document checklist support and CA-assisted review path.",
  ...
  },
  {
    ...
    description: "CA-assisted review with AIS/26AS checks before filing where the case scope supports it.",
    pricing: { qualifier: "fixed", amount: 999, originalAmount: 1499, gstTreatment: "excluding" },
    icon: UserCheck,
    badge: "Recommended",
    featured: true,
    included: ["CA-assisted review", "AIS/26AS checks", "HRA/rent support", "Refund and issue-flag notes"],
...
export const servicePricingCatalog: ServicePricing[] = [
  ...
  },
  {
    ...
    timeline: "After document review",
    caTouchpoints: "CA-assisted review with one clarification loop",
  ...
  },
  {
    ...
    timeline: "Estimated 7-10 working days after document readiness",
  ...
  },
  {
    ...
    timeline: "Estimated 10-15 working days, subject to approvals",
  ...
  },
  {
    ...
    pricing: { qualifier: "starting", amount: 7999, originalAmount: 14999, gstTreatment: "excluding" },
    icon: Building2,
    badge: "Scope first",
  ...
  },
  {
    ...
    timeline: "Estimated 12-18 months, subject to registry examination",
