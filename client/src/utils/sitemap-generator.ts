...
export const sitemapRoutes: SitemapEntry[] = [
  ...
  { loc: 'https://myeca.in/calculators/regime-comparator', changefreq: 'monthly', priority: 0.8 },
  ...
  { loc: 'https://myeca.in/calculators/sip-enhanced', changefreq: 'monthly', priority: 0.7 },
  ...
  { loc: 'https://myeca.in/calculators/fd-enhanced', changefreq: 'monthly', priority: 0.7 },
  ...
  { loc: 'https://myeca.in/calculators/gst', changefreq: 'monthly', priority: 0.8 },
  { loc: 'https://myeca.in/calculators/salary', changefreq: 'monthly', priority: 0.8 },
  { loc: 'https://myeca.in/calculators/gratuity', changefreq: 'monthly', priority: 0.7 },
  { loc: 'https://myeca.in/calculators/epf', changefreq: 'monthly', priority: 0.7 },
  { loc: 'https://myeca.in/calculators/rd', changefreq: 'monthly', priority: 0.7 },
  { loc: 'https://myeca.in/calculators/lumpsum', changefreq: 'monthly', priority: 0.7 },
  { loc: 'https://myeca.in/calculators/swp', changefreq: 'monthly', priority: 0.7 },
  { loc: 'https://myeca.in/calculators/inflation', changefreq: 'monthly', priority: 0.7 },
  { loc: 'https://myeca.in/calculators/loan-eligibility', changefreq: 'monthly', priority: 0.7 },
