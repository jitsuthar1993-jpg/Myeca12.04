...
export const quickStyles = {
  ...
  button: {
    ...
    outline: "border-2 border-slate-300 text-slate-700 hover:border-blue-500 hover:text-blue-600 px-6 py-3 rounded-lg font-medium bg-white transition-all duration-300 opacity-100 visible animate-fade-in",
  ...
  card: {
    base: "bg-white rounded-lg shadow-md hover:shadow-xl transition-all duration-300 p-6 h-full border border-slate-200 hover:-translate-y-1 animate-fade-in",
    feature: "bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 p-6 h-full border border-slate-200 hover:-translate-y-1 animate-scale-in",
  ...
  section: {
    ...
    gray: "bg-slate-50 py-16 lg:py-20",
    blue: "bg-gradient-to-r from-blue-600 to-blue-700 text-white py-16 lg:py-20 rounded-2xl"
  },

  // Text styles with animations
  text: {
    heading: "text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 mb-4 animate-slide-up",
    subheading: "text-lg md:text-xl text-slate-600 max-w-3xl mx-auto animate-fade-in",
  ...
  // Form elements
  form: {
    input: "w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 animate-fade-in",
    select: "w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-white animate-fade-in",
    label: "block text-sm font-medium text-slate-700 mb-2 animate-fade-in"
  },
