...
export const blogPostEditorSchema = z.object({
  ...
  reviewerRole: z.string().trim().optional().nullable(),
  reviewerCredentialName: z.string().trim().optional().nullable(),
  reviewerCredentialId: z.string().trim().optional().nullable(),
  reviewerCredentialAuthority: z.string().trim().optional().nullable(),
...
export const publicBlogSummarySchema = z.object({
  ...
  reviewerRole: z.string().optional().nullable(),
  reviewerCredentialName: z.string().optional().nullable(),
  reviewerCredentialId: z.string().optional().nullable(),
  reviewerCredentialAuthority: z.string().optional().nullable(),
