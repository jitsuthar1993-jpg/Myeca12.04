...
- Your gross total income exceeds the basic exemption limit (Rs 2.5 lakh under Old Regime, Rs 3 lakh under New Regime)
- You have deposited more than Rs 1 crore in a bank account in a year
- You have incurred more than Rs 2 lakh on foreign travel
- You have paid electricity bills exceeding Rs 1 lakh
- Your TDS / TCS amount is Rs 25,000 or more (Rs 50,000 for senior citizens)
...
Additional surcharges apply for income above Rs 50 lakh, and a **4% Health & Education Cess** applies on all tax amounts.
...
> **Budget 2025 Update:** Under the New Regime, resident individuals with income up to **Rs 12 lakh** effectively pay zero tax after the enhanced Section 87A rebate of Rs 60,000. Salaried individuals additionally get a **Rs 75,000 standard deduction**, pushing the effective zero-tax threshold to Rs 12.75 lakh.
...
5. **Income from Other Sources** - Interest on savings/FDs, dividends, lottery winnings, gifts above Rs 50,000
...
- **Section 80C**: Up to Rs 1,50,000 (PPF, ELSS, LIC premium, home loan principal, tuition fees)
...
|---|---|
| Rs 50 lakh - Rs 1 crore | 10% of tax |
| Rs 1 crore - Rs 2 crore | 15% of tax |
| Rs 2 crore - Rs 5 crore | 25% of tax |
| Above Rs 5 crore | 37% of tax (25% under New Regime) |
...
- Up to Rs 2,00,000 deduction on home loan interest for a self-occupied property
...
Late filing attracts a penalty of Rs 5,000 (Rs 1,000 if income is below Rs 5 lakh). Additionally, you may face interest under Sections 234A, 234B, and 234C on unpaid tax.`,
    },
...
e-Filing means submitting your **Income Tax Return (ITR)** electronically through the Income Tax Department's official portal at **incometax.gov.in**. It replaced the old paper-based filing system and is now mandatory for most taxpayers, including individuals with income above Rs 5 lakh and companies.
...
- The portal auto-fills a Rs 50,000 standard deduction (Rs 75,000 under New Regime)

**House Property:**
- Enter annual rental income received
- Deduct municipal taxes paid
- Claim 30% standard deduction and home loan interest (up to Rs 2 lakh for self-occupied)
...
|---|---|
| 80C | PPF, ELSS, LIC, EPF, home loan principal (max Rs 1.5L) |
| 80D | Health insurance premiums (max Rs 25,000 - Rs 1L) |
| 80E | Education loan interest |
| 80G | Donations |
| 24(b) | Home loan interest (max Rs 2L for self-occupied) |
...
ITR-1 is the simplest form, designed for resident individuals whose total income does not exceed **Rs 50 lakh** and comes only from:
...
- Those with total income above Rs 50 lakh
...
ITR-3 is the most comprehensive form for individuals. It requires a full **P&L account and balance sheet** if turnover exceeds Rs 25 lakh (for professionals) or Rs 2.5 crore (for businesses).
...
|---|---|---|
| **44AD** | Small businesses with turnover up to Rs 3 crore (digital receipts) or Rs 2 crore (cash) | 8% or 6% of turnover |
| **44ADA** | Professionals (doctors, CAs, lawyers etc.) with receipts up to Rs 75 lakh | 50% of gross receipts |
...
- Those with income above Rs 50 lakh (individuals)
...
**Q: I am salaried and also earned Rs 5,000 from a YouTube channel. Which form?**
...
If you opt for the presumptive scheme under 44ADA (gross receipts <= Rs 75 lakh), use **ITR-4**. Otherwise, use **ITR-3** with proper books.

**Q: My employer deducted TDS and I have no other income. Can I still file ITR-1?**
Yes, provided your income is only from salary, one house property, and other sources - and the total does not exceed Rs 50 lakh.
...
- **Section 80C** - for savings and investments (up to Rs 1,50,000 per year)
...
Section 80C of the Income Tax Act allows individual taxpayers and HUFs to deduct up to **Rs 1,50,000** per financial year from their gross total income for specified investments and expenditures. This is a combined limit - it is not Rs 1.5 lakh for each item listed below, but Rs 1.5 lakh in total across all eligible options.
...
| National Pension System (NPS) | Till age 60 | Market-linked | Additional Rs 50K under 80CCD(1B) |
...
| Expenditure | Details |
|---|---|
| Life Insurance Premium | For self, spouse, and children; sum assured must be >= 10x premium |
...
Over and above the Rs 1.5 lakh 80C limit, you can claim an **additional deduction of Rs 50,000** for contributions to the National Pension System (NPS) under Section **80CCD(1B)**. This brings your potential total deduction to **Rs 2 lakh** through 80C + NPS.
...
| Parents (senior citizens, 60+) | Rs 50,000 |
| Self (senior citizen, 60+) | Rs 50,000 |

**The maximum possible deduction under 80D in a single year:**
- If you are below 60 and parents are senior citizens: Rs 25,000 + Rs 50,000 = **Rs 75,000**
- If both you and your parents are senior citizens: Rs 50,000 + Rs 50,000 = **Rs 1,00,000**
...
- Up to **Rs 5,000** per year for self, spouse, children, and parents
...
If your parents are senior citizens (60+) and **do not have a health insurance policy**, you can claim a deduction of up to **Rs 50,000** for **medical expenses actually incurred** on their treatment. This is particularly useful if insuring elderly parents is difficult or prohibitively expensive.
...
- **80TTA**: Deduction up to **Rs 10,000** on savings account interest for individuals below 60
- **80TTB**: Deduction up to **Rs 50,000** on all interest income (savings account + FD) for **senior citizens** - replaces 80TTA for those above 60
...
**Q: I invested Rs 2 lakh in ELSS. Can I claim the full Rs 2 lakh under 80C?**
No. The 80C limit is capped at Rs 1.5 lakh regardless of how much you invest. You cannot claim the excess Rs 50,000 under 80C.
...
> **Note on EPS:** The 8.33% employer contribution (on Rs 15,000 ceiling = Rs 1,250/month) goes to the **Employees' Pension Scheme (EPS)** - this is not shown in your EPF passbook as withdrawable balance. It is paid as a pension after retirement.
